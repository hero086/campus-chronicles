...
const AD_POOL = [
    ...
    { title: "Poster Printing — Next-day", copy: "Event posters printed affordably. Student societies discount.", img: "https://images.unsplash.com/photo-1541848566-1c781849a379?auto=format&fit=crop&q=80&w=800" },
    ...
    { title: "Late Night Study Snacks", copy: "Order hot samosas delivered to your dorm — 10% student discount.", img: "https://images.unsplash.com/photo-1601050690597-df0568270440?auto=format&fit=crop&q=80&w=800" },
    { title: "Poster Printing Express", copy: "Get event posters printed and laminated within 24 hours.", img: "https://images.unsplash.com/photo-1621999699029-23a735c93149?auto=format&fit=crop&q=80&w=800" }
];
...
const CATEGORIES = [
    ...
    },
    {
        ...
        articles: [
            ...
            article("Study Space App Adds Quiet Zone Indicator", 19, "The campus study-space app introduced a quiet-zone indicator to help students find calmer areas.", "The update uses volunteer reports and simple sensors to flag quieter rooms during busy periods. Developers plan to add seating counts and a booking window for high-demand zones.", "Students welcomed the clearer signals for quiet places during revision peaks.", "https://images.unsplash.com/photo-1633356122544-49635418b8d6?auto=format&fit=crop&q=80&w=1024")
        ]
    },
    {
        slug: "sports",
